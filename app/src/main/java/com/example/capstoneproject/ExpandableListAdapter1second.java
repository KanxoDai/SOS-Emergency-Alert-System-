...
public class ExpandableListAdapter1second extends BaseExpandableListAdapter {
    ...
    public ExpandableListAdapter1second(Activity context, List<String> listDataHeader, int[] drawerImageIds, Typeface custom, Typeface custom2) {
    ...
    public ExpandableListAdapter1second(Activity context, List<String> listDataHeader,
                                        Typeface custom, Typeface custom2) {
        this._context=context;
        this._listDataHeader=listDataHeader;
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.exp_group_itemsecond, null);
        }
