    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerexpList.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v,
                ...
                if (groupPosition == 2) {
                    finish();
                    Intent intent=new Intent(dashboard.this, my_contact.class);
                    startActivity(intent);
                    mDrawerLayout.closeDrawer(mDrawerexpList);
                }
               if (groupPosition == 3){
...
//                if (groupPosition == 4){
//                    finish();
//                    Intent intent=new Intent(dashboard.this, action_screen.class);
//                    startActivity(intent);
//                    mDrawerLayout.closeDrawer(mDrawerexpList);
//                }
                if (groupPosition == 4){
                    finish();
                    Intent intent=new Intent(dashboard.this, FirstPage.class);
                    startActivity(intent);
                    mDrawerLayout.closeDrawer(mDrawerexpList);
                }
                if (groupPosition == 5){
    ...
    private boolean hasContact() {
        ...
        if (contact.isEmpty()) {
            ...
            Toast.makeText(dashboard.this, "Please add at least 1 Emergency Contact", Toast.LENGTH_SHORT).show();
            return false;
        } else {
            return true;
        }
