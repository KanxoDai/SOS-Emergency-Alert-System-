...
public class DBHelpersecond extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "EmergencyDatabaseMain2";

    // Customer table name
    private static final String TABLE_CONTACTS = "EmerContact2";
    ...
    public DBHelpersecond(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version, @Nullable DatabaseErrorHandler errorHandler) {
    ...
    public String addContact(EmerContactsecond contact) {
        String toast = "";
    ...
    public List<EmerContactsecond> getContact(String email) {
        List<EmerContactsecond> contactList = new ArrayList<EmerContactsecond>();
        ...
        for (int i = 0; i < contacts.size(); i++) {
            ...
            EmerContactsecond contact = new EmerContactsecond();
    ...
    public String exist(SQLiteDatabase db, EmerContactsecond contact) {
    ...
    {
        SQLiteDatabase db = this.getWritableDatabase();
        String qry="select * from "+ TABLE_CONTACTS ;
