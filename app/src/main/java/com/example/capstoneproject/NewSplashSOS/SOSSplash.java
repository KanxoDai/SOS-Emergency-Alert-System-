package com.example.capstoneproject.NewSplashSOS;
...
import com.example.capstoneproject.login_screen;
import com.example.capstoneproject.ui.HomeScreenActivity;
...
public class SOSSplash extends AppCompatActivity implements
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (checkSelfPermission(Manifest.permission.ACCESS_FINE_LOCATION)
                ...
                if (shouldShowRequestPermissionRationale(
                    ...
                    new AlertDialog.Builder(SOSSplash.this)
                            .setTitle(R.string.location_permission_title)
                            .setMessage(R.string.location_permission_message)
                            .setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ActivityCompat.requestPermissions(SOSSplash.this, new String[]{
                                                    Manifest.permission.ACCESS_FINE_LOCATION},
                    ...
                    requestPermissions(new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.READ_PHONE_STATE, Manifest.permission.SEND_SMS},
                            LOCATION_PERMISSION_CODE);
            } else
                getGPSPermission();
        } else
        ...
        if (ActivityCompat.checkSelfPermission(this, Arrays.toString(new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.READ_PHONE_STATE, Manifest.permission.SEND_SMS}))
                != PackageManager.PERMISSION_GRANTED &&
                ActivityCompat.checkSelfPermission(this, Arrays.toString(new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.READ_PHONE_STATE, Manifest.permission.SEND_SMS}))
                        != PackageManager.PERMISSION_GRANTED) {
        ...
        switch (status.getStatusCode()) {
            case LocationSettingsStatusCodes.SUCCESS:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        startActivity(new Intent(SOSSplash.this, FirstPage.class));
            ...
            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                ...
                try {
                    ...
                    // in onActivityResult().
                    status.startResolutionForResult(SOSSplash.this, LOCATION_REQUEST_CODE);
    ...
    private void getGPSPermission() {
        ...
        result.setResultCallback(SOSSplash.this);
    }
}
